...
Vagrant::configure("2") do |config|
  ...
  config.vm.provision 'install build deps',         type: "shell", inline: "DEBIAN_FRONTEND=noninteractive apt-get -qq -y install libdevel-cover-perl libtest-exception-perl libdata-dump-perl libfile-slurp-perl libgraph-perl libjson-perl liblog-log4perl-perl liblwp-useragent-determined-perl libmoose-perl libmoosex-aliases-perl libparams-validate-perl libset-scalar-perl libtemplate-perl libwww-perl"
